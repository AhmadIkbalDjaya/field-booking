              ...
              <div class="container-fluid">
                ...
                <div class="row text-center">
                  <div class="col-md-1 px-3 py-2" style="width: auto">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">10.00 - 12.00</button>
                  </div>
                  <div class="col-md-1 px-3 py-2" style="width: auto">
                    <button type="button" class="btn btn-secondary btn-sm" disabled data-bs-toggle="modal" data-bs-target="#exampleModal">12.00 - 01.00</button>
                  </div>
                  <div class="col-md-1 px-3 py-2" style="width: auto">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">01.00 - 02.00</button>
                  </div>
                </div>
              </div>
            </div>
